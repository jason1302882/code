...
//			if (p_iommu_priv->chip == SPRD_IOMMUEX_SHARKLE)
//				phy_addr -= 0x80000000;  //for 9832E 3G DDR by wqj
...
//	if (p_iommu_priv->chip == SPRD_IOMMUEX_SHARKLE)
//		pgt_addr_phy -= 0x80000000;   //for 9832E 3G DDR by wqj
...
//	if (p_iommu_priv->chip == SPRD_IOMMUEX_SHARKLE)
//		fault_page -= 0x80000000;   //for 9832E 3G DDR by wqj
