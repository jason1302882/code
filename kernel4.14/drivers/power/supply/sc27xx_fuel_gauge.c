...
static const struct sc27xx_fgu_variant_data sc2721_info = {
				   ...
				   union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_PRESENT:
		...
		dev_err(data->dev, "sc27xx_fgu_get_property,bat_present:%d\n", data->bat_present);
		break;
...
static irqreturn_t sc27xx_fgu_bat_detection(int irq, void *dev_id)
{
	...
	data->bat_present = true;	//!!state;
	dev_err(data->dev, "sc27xx_fgu_bat_detection,bat_present:%d\n", data->bat_present);
...
static const struct of_device_id sc27xx_fgu_of_match[] = {
	...
	{ .compatible = "sprd,sc2721-fgu", .data = &sc2721_info},
	{ }
};
